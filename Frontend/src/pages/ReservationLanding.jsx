            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mb-8 text-black">
                    ...
                    <div className="flex flex-wrap gap-4 mb-6">
                        ...
                        <Link
                            to="/my-reservations"
                            className="bg-gray-100 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-200 transition-colors flex items-center"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <h2 className="text-xl font-bold mb-4">Filter Ruangan</h2>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredRooms.map((room) => (
                            <div key={room.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow text-black">
